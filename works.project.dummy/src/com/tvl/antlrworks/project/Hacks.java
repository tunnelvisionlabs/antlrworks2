...
public class Hacks {
    ...
    static void keepCurrentProjectNameUpdated() {
        ...
        final RequestProcessor.Task task = RP.create(new Runnable() {
            ...
            public @Override void run() {
                ...
                boolean noProjectsOpen = OpenProjects.getDefault().getOpenProjects().length == 0;
    ...
    /** Forces reload of panels in {@link TemplateWizard}. Public method {@link TemplateWizard#updateState} doesn't re-read
     * the new panels from new iterator.
     * Note: it should be solved better either fixing {@link TemplateWizard} or implement
     * whole {@link NewFileWizard} (w/o {@link TemplateWizard}).
     *
