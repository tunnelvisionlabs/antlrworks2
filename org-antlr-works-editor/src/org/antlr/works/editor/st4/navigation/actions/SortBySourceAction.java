...
public class SortBySourceAction extends AbstractAction implements Presenter.Popup {
    ...
    public SortBySourceAction(TemplatesFilters filters) {
        this.filters = filters;
        putValue(Action.NAME, NbBundle.getMessage(SortByNameAction.class, "LBL_SortBySource"));
        putValue(Action.SMALL_ICON, ImageUtilities.loadImageIcon("org/antlr/works/editor/st4/navigation/resources/sortPosition.png", false));
    }
