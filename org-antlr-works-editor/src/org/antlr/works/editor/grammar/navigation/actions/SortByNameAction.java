...
public class SortByNameAction extends AbstractAction implements Presenter.Popup {
    ...
    public SortByNameAction(GrammarRuleFilters filters) {
        this.filters = filters;
        putValue(Action.NAME, NbBundle.getMessage(SortByNameAction.class, "LBL_SortByName"));
        putValue(Action.SMALL_ICON, ImageUtilities.loadImageIcon("org/antlr/works/editor/grammar/navigation/resources/sortAlpha.png", false));
    }
